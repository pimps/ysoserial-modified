...
public class TestHarnessTest {
	...
	public static class ExecMockPayload implements ObjectPayload<ExecMockSerializable> {
		public ExecMockSerializable getObject(CmdExecuteHelper cmdHelper) throws Exception {
			return new ExecMockSerializable(cmdHelper);
		}
	}

	public static class NoopMockPayload implements ObjectPayload<Integer> {
		public Integer getObject(CmdExecuteHelper cmdHelper) throws Exception {
			return 1;
		}
	}
	...
	public static class ExecMockSerializable implements Serializable {
		...
		public ExecMockSerializable(CmdExecuteHelper cmdHelper) { this.cmd = cmdHelper.getCommand(); }
