...
public class JSON1 implements ObjectPayload<Object> {
    ...
    public Map getObject ( CmdExecuteHelper cmdHelper ) throws Exception {
        return makeCallerChain(Gadgets.createTemplatesImpl(cmdHelper.getCommandArray()), Templates.class);
    }
